...
//
//	private StructureMapSingleton(String inMapName,StructureMap inStructureMap, String inObjectId) {
...
//	}
//	
//    public static StructureMapSingleton getAndUpdateInstance(final String mapUri, final String objectId) {
...
//			if (instance == null) {
//				try { 
//	            	StructureMapDTO mapETY = structuresRepo.findMapByName(mapName, objectId);
...
//	                instance = new StructureMapSingleton(mapName, structuredMap,objectId);
