...
import static it.finanze.sanita.fse2.gtwfhirmappingenginems.config.Constants.Profile.*;
...
public class ProfileUtility {
    ...
    public boolean isDockerProfile(){
        if (environment != null && environment.getActiveProfiles().length > 0) {
            return environment.getActiveProfiles()[0].toLowerCase().contains(DOCKER);
        }
        return false;
    }
